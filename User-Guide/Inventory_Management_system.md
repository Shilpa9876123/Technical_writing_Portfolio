...
The Inventory Management System (IMS) is a web-based application that helps organizations manage products, inventory, suppliers, and customer orders from a centralized platform.

The application enables users to monitor inventory levels, update stock information, manage purchase and sales orders, and generate reports for inventory analysis.

This guide provides instructions for accessing and using the Inventory Management System.
...
Before using the Inventory Management System, ensure that:

- You have a valid user account.
- You have access to the application URL.
- You have a stable internet connection.
- You are using one of the following supported web browsers:
  - Google Chrome
  - Microsoft Edge
  - Mozilla Firefox
...
- You have received your username and password from the system administrator.
- Your account is active.

## Procedure

1. Open the Inventory Management System URL in your web browser.
...
The Dashboard page opens. The available modules depend on your assigned user role and permissions.
...
The system creates the product and displays a confirmation message.
...
> **Warning**
>
> Deleted products cannot be restored unless a system backup is available.
...
The inventory quantity is updated successfully.
...
The inventory is transferred successfully.
...
Select the notification icon to view recent notifications.
